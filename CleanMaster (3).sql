...
INSERT INTO `reservarCita` VALUES(1, 1, 1, '2024-10-15', 1, 'Calle Falsa 123, Ciudad A', 'Limpieza profunda');
INSERT INTO `reservarCita` VALUES(2, 2, 2, '2024-10-16', 2, 'Calle Nueva 456, Ciudad B', 'Corte de pelo');
INSERT INTO `reservarCita` VALUES(3, 3, 1, '2024-10-17', 3, 'Calle Vieja 789, Ciudad C', 'Masaje relajante');
...
INSERT INTO `tiposServicios` VALUES(1, 'Limpieza');
INSERT INTO `tiposServicios` VALUES(2, 'Peluquería');
INSERT INTO `tiposServicios` VALUES(3, 'Masajes');


ALTER TABLE `direcciones`
  ADD CONSTRAINT `direcciones_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `empleado_tiposServicios`
  ADD CONSTRAINT `empleado_tiposServicios_ibfk_1` FOREIGN KEY (`idEmpleado`) REFERENCES `empleado` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `empleado_tiposServicios_ibfk_2` FOREIGN KEY (`idTipoServicio`) REFERENCES `tiposServicios` (`id`) ON DELETE CASCADE;

ALTER TABLE `mensaje`
  ADD CONSTRAINT `mensaje_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `mensaje_ibfk_2` FOREIGN KEY (`idEmpleado`) REFERENCES `empleado` (`id`) ON DELETE CASCADE;

ALTER TABLE `reservarCita`
  ADD CONSTRAINT `reservarCita_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `reservarCita_ibfk_2` FOREIGN KEY (`idEmpleado`) REFERENCES `empleado` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `reservarCita_ibfk_3` FOREIGN KEY (`idTipoServicio`) REFERENCES `tiposServicios` (`id`) ON DELETE CASCADE;
COMMIT;
